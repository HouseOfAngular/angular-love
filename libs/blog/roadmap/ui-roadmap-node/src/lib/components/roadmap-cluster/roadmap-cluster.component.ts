...
@Component({
  ...
  host: {
    class:
      'block bg-linear-to-br from-[#100F15] to-[#3B0019] light:from-[al-primary] light:to-[al-primary] rounded-lg text-center border-2 light:border-(--primary-foreground) border-[#FDF5FD]',
  },
})
