/* eslint-disable */
// Generated by Wrangler by running `wrangler types apps/blog-analog/worker-configuration.d.ts --config apps/blog-analog/wrangler.jsonc` (hash: c45fb3d732fe8d56f17f60a2e1e76aa4)
