/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/blog-analog/wrangler.jsonc apps/blog-analog/worker-configuration.d.ts` (hash: 492cfba6be08ec215d99591a2262c58f)
// Runtime types generated with workerd@1.20260609.1 2025-09-27 nodejs_compat
interface __BaseEnv_Env {
  ...
  VITE_AL_ALGOLIA_INDEX_NAME: string;
  VITE_AL_ALGOLIA_API_KEY: string;
  VITE_AL_GISCUS_REPO: string;
  VITE_AL_GISCUS_REPO_ID: string;
...
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import('../../dist/apps/blog-analog/analog/server/index');
  }
  interface ProdEnv {
    CACHE_KV: KVNamespace;
    ASSETS: Fetcher;
  ...
  interface ProcessEnv
    extends StringifyValues<
      Pick<
        ...
        | 'VITE_AL_ALGOLIA_INDEX_NAME'
        | 'VITE_AL_ALGOLIA_API_KEY'
        | 'VITE_AL_GISCUS_REPO'
        | 'VITE_AL_GISCUS_REPO_ID'
