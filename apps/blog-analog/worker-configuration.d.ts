/* eslint-disable */
// Generated by Wrangler by running `wrangler types apps/blog-analog/worker-configuration.d.ts --config apps/blog-analog/wrangler.jsonc` (hash: cb317402f22c8d3f45b4bc349b6ffbab)
